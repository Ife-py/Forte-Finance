...
@section('content')
    <div class="container py-4">
        ...
        <!-- Search -->
        <form action="{{ route('admin.certificates.search') }}" method="GET" class="mb-4">
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card shadow-sm border-0 h-100">
                        @if ($certificate->certificate_image)
                            <img src="{{ asset('storage/' . $certificate->certificate_image) }}" alt="Certificate Image"
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="mb-1"><strong>Course:</strong> {{ $certificate->course->title ?? 'N/A' }}</p>
                            <p class="text-muted mb-3"><small><i class="uil uil-calendar-alt"></i> Issued:
                                    {{ $certificate->issued_at }}</small></p>
