...
<div class="container py-4">
            ...
            <div class="card shadow-lg border-0">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="ms-4">
                        ...
                        <p class="mb-0 text-muted"><i class="uil uil-calendar-alt"></i> Joined: {{ $student->created_at->format('M d, Y') }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-4">
        <div class="col-lg-8 mx-auto text-end">
            <a href="{{ route('admin.students.edit', $student->id) }}" class="btn btn-warning me-2"><i class="uil uil-edit"></i> Edit Student</a>
