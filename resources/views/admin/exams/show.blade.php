            ...
            <div>
                ...
                <div class="mt-2">
                    <small class="text-secondary d-block">
                        ...
                        <strong>Phase:</strong> {{ ucfirst($exam->phase) }}
                    </small>
                    ...
                    @if ($exam->start_time && $exam->end_time)
                        ...
                        <small class="text-secondary d-block">
                            <i class="uil uil-clock me-1"></i>
                            <strong>End Time:</strong> {{ \Carbon\Carbon::parse($exam->end_time)->format('M d, Y h:i A') }}
                        </small>
                    @else
                        <small class="text-muted d-block">
                            <i class="uil uil-clock-slash me-1"></i> No schedule set for this exam
                        </small>
                    @endif
                </div>
            </div>
                ...
                <div class="card mb-3 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            {{-- Delete Question --}}
                            <form action="{{ route('admin.exams.questions.delete', [$exam->id, $question->id]) }}"
